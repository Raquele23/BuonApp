            ...
            <div class="flex grow">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('images/minha-logo.png') }}" alt="Minha Logo" class="h-9 w-auto">
                    </a>
                </div>

                <!-- Navigation Links -->
                <div class="hidden sm:flex sm:flex-nowrap sm:gap-x-4 sm:ms-4">
                    ...
                    <x-nav-link :href="route('pratos.index')" :active="request()->routeIs('pratos.*')">
                        Pratos
                    </x-nav-link>
