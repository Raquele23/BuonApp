            ...
            <div class="bg-white dark:bg-gray-800 shadow-xl sm:rounded-lg p-8">
                ...
                <form action="{{ route('pratos.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nome" value="{{ old('nome') }}" placeholder="Ex: Lasanha Bolonhesa" required class="w-full px-4 py-2 rounded-lg bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100 border border-gray-300 dark:border-gray-600 focus:ring-green-600 focus:border-green-600">
                    ...
                    <div>
                        ...
                        <textarea name="descricao" rows="4" placeholder="Ex: Camadas de massa fresca, molho à bolonhesa, bechamel e queijo parmesão" class="w-full px-4 py-2 rounded-lg bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100 border border-gray-300 dark:border-gray-600 focus:ring-green-600 focus:border-green-600">{{ old('descricao') }}</textarea>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="preco" value="{{ old('preco') }}" placeholder="Ex: 32.50" required class="w-full px-4 py-2 rounded-lg bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100 border border-gray-300 dark:border-gray-600 focus:ring-green-600 focus:border-green-600">
